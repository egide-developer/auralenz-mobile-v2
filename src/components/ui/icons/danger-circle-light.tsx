...
export function DangerCircleLight({ size = 24, color = "#000000", strokeWidth = 1.5 }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <title>Iconly/Light-Outline/Danger Circle</title>
    <g id="Iconly/Light-Outline/Danger-Circle" stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd">
        <g id="Danger-Circle" transform="translate(2.000000, 2.000000)" fill={color}>
