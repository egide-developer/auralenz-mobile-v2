...
export function TimeCircleBold({ size = 24, color = "#000000", strokeWidth = 1.5 }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G id="Iconly/Light-Outline/Time-Circle" stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd">
        <G id="Time-Circle" transform="translate(2.000000, 2.000000)" fill={color}>
