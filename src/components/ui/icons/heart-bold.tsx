...
export function HeartBold({ size = 24, color = "#000000", strokeWidth = 1.5 }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <g id="Iconly/Light-Outline/Heart" stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd">
