...
export function HeartLight({ size = 24, color = "#000000", strokeWidth = 1.5 }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <title>Iconly/Light/Heart</title>
    <g id="Iconly/Light/Heart" stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
        <g id="Heart" transform="translate(2.500000, 3.000000)" stroke={color} strokeWidth={strokeWidth}>
