...
export function ArrowUp2Bold({ size = 24, color = "#000000", strokeWidth = 1.5 }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <title>Iconly/Light-Outline/Arrow - Up 2</title>
    <g id="Iconly/Light-Outline/Arrow---Up-2" stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd">
        <g id="Arrow---Up-2" transform="translate(12.000000, 12.000000) rotate(-180.000000) translate(-12.000000, -12.000000) translate(4.000000, 7.500000)" fill={color} fill-rule="nonzero">
