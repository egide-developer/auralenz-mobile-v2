...
export function PaperNegativeLight({ size = 24, color = "#000000", strokeWidth = 1.5 }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <title>Iconly/Light/Paper Negative</title>
    <g id="Iconly/Light/Paper-Negative" stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
        <g id="Paper-Negative" transform="translate(3.500000, 2.000000)" stroke={color} strokeWidth={strokeWidth}>
