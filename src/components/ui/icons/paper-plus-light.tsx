...
export function PaperPlusLight({ size = 24, color = "#000000", strokeWidth = 1.5 }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <g id="Iconly/Light/Paper-Plus" stroke="none" strokeWidth={strokeWidth} fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
        <g id="Paper-Plus" transform="translate(3.500000, 2.000000)" stroke={color} strokeWidth={strokeWidth}>
